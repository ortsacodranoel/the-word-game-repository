...
class CategoriesViewController: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource
{
    ...
    func collectionView(collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        return self.game.categoriesArray.count
    }
    ...
    func collectionView(collectionView: UICollectionView, cellForItemAtIndexPath indexPath: NSIndexPath) -> UICollectionViewCell {
        ...
        cell.categoryButton.backgroundColor = self.game.categoriesArray[indexPath.row].color
        cell.categoryButton.setTitle(self.game.categoriesArray[indexPath.row].title, forState: UIControlState.Normal)
